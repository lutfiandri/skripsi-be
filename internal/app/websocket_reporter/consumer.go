...
type Consumer struct {
	...
	app         *fiber.App
	messageChan chan device_state_log_dto.DeviceStateLog[any]
}

func NewConsumer(app *fiber.App, redisClient *redis.Client) Consumer {
	return Consumer{
		app:         app,
		redisClient: redisClient,
		messageChan: make(chan device_state_log_dto.DeviceStateLog[any]),
	}
}
